...
public class JSON {
    ...
    public static class OffsetDateTimeTypeAdapter extends TypeAdapter<OffsetDateTime> {
        ...
        public OffsetDateTime TryParseMicrosoftDatetime(String dateStr)
        {
            ...
            if (matcher.find()) {
                if (matcher.groupCount() >= 2)
                    zoneId = ZoneId.of(matcher.group(2));
                if (matcher.groupCount() >= 1) {
                    Instant timepart = Instant.ofEpochMilli(Long.valueOf(matcher.group(1)));
                    result = OffsetDateTime.ofInstant(timepart, zoneId);
                }
            }
        ...
        public OffsetDateTime read(JsonReader in) throws IOException {
            switch (in.peek()) {
                ...
                default:
                    ...
                    OffsetDateTime tmp = TryParseMicrosoftDatetime(date);
                    if (null != tmp)
                        return tmp;
    ...
    public static class ByteArrayAdapter  extends TypeAdapter<byte[]> {
        ...
        public void write(JsonWriter out, byte[] data) throws IOException {
            if (data == null) {
                ...
                value = Base64.encodeToString(data, false);
